...
//     fetch('http://127.0.0.1:5000/api/travellers')
//         .then(response => response.json())
//         .then(data => {
//             populateTravellerForms(data);
//         })
...
// // Function to save data to backend instead of localStorage
...
// // Function to populate traveller forms from mock data
// function populateTravellerForms(data) {
//     data.travellers.forEach((traveller, index) => {
//         const i = index + 1; // IDs start at 1
//         document.getElementById(`fullName${i}`).value = traveller.fullName;
//         document.getElementById(`age${i}`).value = traveller.age;
//         document.getElementById(`gender${i}`).value = traveller.gender;
//         document.getElementById(`passport${i}`).value = traveller.passport;
//         document.getElementById(`nationality${i}`).value = traveller.nationality;
//         document.getElementById(`email${i}`).value = traveller.email;
//         document.getElementById(`phone${i}`).value = traveller.phone;
//     });
...
// // Form elements
// const travellerForms = document.querySelectorAll('.traveller-form');

// // Price calculation
// let basePrice = 1080;
// let insurancePerTraveller = 49;
// let travellerCount = parseInt(localStorage.getItem('numTravelers')) || 2;
...
// // Function to generate traveler forms dynamically
// function generateTravelerForms(num) {
//     travelerContainer.innerHTML = ''; // Clear container first

//     for (let i = 1; i <= num; i++) {
//         const travelerDiv = document.createElement("div");
//         travelerDiv.classList.add("traveller-form", "mb-3");
//         travelerDiv.innerHTML = `
//             <h5>Traveler ${i}</h5>

//             <label for="fullName${i}" class="form-label">Full Name:</label>
//             <input type="text" class="form-control" id="fullName${i}" placeholder="Enter full name" required>

//             <label for="age${i}" class="form-label mt-2">Age:</label>
//             <input type="number" class="form-control" id="age${i}" placeholder="Enter age" required>

//             <label for="gender${i}" class="form-label mt-2">Gender:</label>
...
//             <label for="passport${i}" class="form-label mt-2">Passport/ID:</label>
//             <input type="text" class="form-control" id="passport${i}" placeholder="Enter Passport/ID" required>

//             <label for="nationality${i}" class="form-label mt-2">Nationality:</label>
//             <input type="text" class="form-control" id="nationality${i}" placeholder="Enter nationality" required>

//             <label for="email${i}" class="form-label mt-2">Email:</label>
//             <input type="email" class="form-control" id="email${i}" placeholder="Enter email" required>

//             <label for="phone${i}" class="form-label mt-2">Phone:</label>
//             <input type="tel" class="form-control" id="phone${i}" placeholder="Enter phone" required>
//         `;
...
// document.addEventListener('DOMContentLoaded', function() {
//     // Populate forms from mock data
//     populateTravellerForms(mockBookingData);

//     // Then initialize your other stuff
//     setupEventListeners();
//     loadSavedData();
// });
// // Every 30 seconds
